...
public sealed class AesClaimsProtector
{
    private readonly byte[] _key;

    public AesClaimsProtector(IOptions<JwtSettings> jwtOptions)
    {
    ...
    public string Unprotect(string protectedValue)
    {
        ...
        {
            throw new InvalidOperationException("The encrypted claim payload is invalid.");
        }
